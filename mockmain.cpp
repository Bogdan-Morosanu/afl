...
int main(int argc, char **argv) {
  ...
  m = Mat3x3d{
      0.5797200, 0.8562388, 0.6963766, 0.7862408, 0.0091269,
      0.8417164, 0.1307007, 0.8219878, 0.5528331,
  };
  ...
  if (success) {
    std::cout << m * sol << " = " << std::endl << target << std::endl;
  ...
  std::cout << m.l1_norm() << " " << m.l2_norm() << " " << m.linf_norm()
            << std::endl;
